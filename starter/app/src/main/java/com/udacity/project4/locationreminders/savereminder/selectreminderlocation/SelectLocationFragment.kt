...
class SelectLocationFragment : BaseFragment(), OnMapReadyCallback {
    ...
    override fun onRequestPermissionsResult(
        ...
        {
            Snackbar.make(
                binding.saveReminderMapContainer,
    ...
    private fun checkDeviceLocationSettingsAndSetCurrentLocation(resolve: Boolean = true) {
        ...
        locationSettingsResponseTask.addOnCompleteListener {
            if (it.isSuccessful) {
                // Location permissions were granted => enable my location button & set current location
    ...
    /**
     * Retrieves and zooms to the current device location
     */
    @SuppressLint("MissingPermission")
